...
def read_text_files():
    ...
    path_empregados = 'data/silver/empregados.txt'
    path_bancos = 'data/silver/bancos.txt'
    path_reclamacoes = 'data/silver/reclamacoes.txt'
...
def main():
    ...
    csv_path = 'data/gold/dados_finais.csv'
