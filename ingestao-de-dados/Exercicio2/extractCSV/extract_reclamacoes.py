...
diretorio = {
    'diretorio1': r'\Dados\Reclamacoes'  # Caso necessário, insira aqui o caminho para o primeiro diretório!
}
...
def carregar_csvs_reclamacoes(diretorio):
...
reclamacoes_df = carregar_csvs_reclamacoes(diretorio['diretorio1'])
...
if not reclamacoes_df.empty:
    ...
    output_path = os.path.join('data/bronze/reclamacoes.json')
